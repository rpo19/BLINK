        ...
        for test in ['testa', 'testb']:
            ...
            if 'wiki_per' in nil_features:
                X_nil = pd.DataFrame({
                    ...
                    'avg_ner_per_bi': [_to_index.iloc[i[0]]['ner_per'] for i in _linking_results[1]],
                    'avg_ner_loc_bi': [_to_index.iloc[i[0]]['ner_loc'] for i in _linking_results[1]],
                    'avg_ner_org_bi': [_to_index.iloc[i[0]]['ner_org'] for i in _linking_results[1]],
                    'avg_ner_misc_bi': [_to_index.iloc[i[0]]['ner_misc'] for i in _linking_results[1]],
