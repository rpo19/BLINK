...
for d in datasets:
    ...
    nil_tp_bi = bi_df.query('labels != -1 and nil_b >= 0.5').shape[0]
    nil_tn_bi = bi_df.query('labels == -1 and nil_b < 0.5').shape[0]
    nil_fp_bi = bi_df.query('labels == -1 and nil_b >= 0.5').shape[0]
    nil_fn_bi = bi_df.query('labels != -1 and nil_b < 0.5').shape[0]
    
    nil_p_bi = nil_tn_bi / (nil_tn_bi + nil_fn_bi)
    nil_r_bi = nil_tn_bi / (nil_tn_bi + nil_fp_bi)
    nil_f1_bi = 2*nil_p_bi*nil_r_bi/(nil_p_bi+nil_r_bi)
    nil_acc_bi = (nil_tp_bi+nil_tn_bi)/(nil_tp_bi+nil_tn_bi+nil_fp_bi+nil_fn_bi)
    ...
    nil_y = (cross_df['labels'] != -1).astype(int)
    nil_y_pred = cross_df
    ...
    # precision of class 0 == nil
    
    nil_p_cross = nil_tn_cr / (nil_tn_cr + nil_fn_cr)
    nil_r_cross = nil_tn_cr / (nil_tn_cr + nil_fp_cr)
    ...
    report.loc[f'{d}+nil'] = {
            ...
            'nil_r_bi': nil_r_bi,
            'nil_f1_bi': nil_f1_bi,
            'nil_acc_bi': nil_acc_bi,
            'nil_p_cross': nil_p_cross,
            'nil_r_cross': nil_r_cross,
            'nil_f1_cross': nil_f1_cross,
            'nil_acc_cross': nil_acc_cross
        }
report
```
