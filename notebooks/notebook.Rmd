...
def load_models(args, logger=None):
    ...
    if (hasattr(args, 'nil_prediction')
        ...
        nil_prediction_model = _load_torch_model(args.nil_prediction_model, 1)
...
args.nil_prediction_scaler = "../models/nil_pred/stdscaler+max_cross+train_hard_aug.pkl"
args.nil_prediction_model = "../models/nil_pred/nrl+max_cross+train_hard_aug.torch"
