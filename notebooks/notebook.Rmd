...
```{python}
# ls ../model/nil_pred/models_ip/svc_bi+train_hard_aug.pkl

```

```{python}
# ls ../models/nil_pred/stdscaler+max_bi+second_bi+min_bi+mean_bi+median_bi+stdev_bi+max_cross+second_cross+min_cross+mean_cross+median_cross+stdev_cross+train_hard_aug.pkl
```
...
args.nil_prediction_scaler = "../models/nil_pred/stdscaler+max_bi+second_bi+min_bi+mean_bi+median_bi+stdev_bi+max_cross+second_cross+min_cross+mean_cross+median_cross+stdev_cross+train_hard_aug.pkl"
args.nil_prediction_model = "../models/nil_pred/nrl+max_bi+second_bi+min_bi+mean_bi+median_bi+stdev_bi+max_cross+second_cross+min_cross+mean_cross+median_cross+stdev_cross+train_hard_aug.torch"
