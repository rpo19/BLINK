...
def load_models(args, logger=None):
    ...
    if hasattr(args, 'nil_prediction') and args.nil_prediction and hasattr(args, 'nil_prediction_model'):
        nil_prediction_model = _load_lr_model(args.nil_prediction_model)
...
args.nil_prediction_model = "../models/lr_all+train_hard_aug.pkl"
...
```{python}
# !wc -l ../data/BLINK_benchmark/AIDA-YAGO2_testa.jsonl
```
...
```{python}
nil_p = _load_lr_model(args.nil_prediction_model)
```
